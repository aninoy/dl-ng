...
def update_parameters_with_momentum(parameters, grads, v, beta, learning_rate):
    ...
    for l in range(L):
        ...
        v["db" + str(l+1)] = v["db" + str(l+1)] + (1 - beta) * grads["db" + str(l+1)]
        # update parameters
...
```
    ...
    Cost after epoch 1000: 0.572178
    Cost after epoch 2000: 0.601134
    Cost after epoch 3000: 0.597508
    Cost after epoch 4000: 0.552680
    Cost after epoch 5000: 0.530804
    Cost after epoch 6000: 0.418920
    Cost after epoch 7000: 0.284643
    Cost after epoch 8000: 0.333148
    Cost after epoch 9000: 0.457026
